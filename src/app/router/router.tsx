...
import { DatabaseManagementConnector } from '@pages/dashboard/database-management/connectors/database-management.page.connector'
import { PostgresManagementConnector } from '@pages/dashboard/postgres-management/connectors/postgres-management.page.connector'
import { TelegramNotificationRoutesConnector } from '@pages/dashboard/telegram-notification-routes/connectors/telegram-notification-routes.page.connector'
...
import { UserActivityTimelinePageConnector } from '@pages/dashboard/user-activity-timeline/ui/connectors'
            ...
            <Route element={<AuthGuard />}>
                ...
                <Route element={<MainLayout />} path={ROUTES.DASHBOARD.ROOT}>
                    ...
                    <Route path={ROUTES.DASHBOARD.MANAGEMENT.ROOT}>
                        ...
                        />
                        <Route
                            element={<TelegramNotificationRoutesConnector />}
                            path={ROUTES.DASHBOARD.MANAGEMENT.TELEGRAM_NOTIFICATION_ROUTES}
                        />
                        <Route
                            element={<DatabaseManagementConnector />}
                            path={ROUTES.DASHBOARD.MANAGEMENT.DATABASE_MANAGEMENT}
                        />
                        <Route
                            element={<DatabaseManagementConnector />}
                            path={ROUTES.DASHBOARD.MANAGEMENT.DATABASE_BACKUP}
                        />
                        <Route
                            element={<PostgresManagementConnector />}
                            path={ROUTES.DASHBOARD.MANAGEMENT.POSTGRES_MANAGEMENT}
                        />
                    ...
                    <Route path={ROUTES.DASHBOARD.TOOLS.ROOT}>
                        ...
                        />
                        <Route
                            element={<UserActivityTimelinePageConnector />}
                            path={ROUTES.DASHBOARD.TOOLS.USER_ACTIVITY_TIMELINE}
                        />
