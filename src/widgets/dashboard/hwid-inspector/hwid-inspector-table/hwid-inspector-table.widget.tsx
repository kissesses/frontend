...
import { TbDeviceAnalytics, TbExternalLink, TbRefresh, TbRestore, TbShieldLock } from 'react-icons/tb'

import { useBlockHwidWithInvalidation, useGetAllHwidDevices } from '@shared/api/hooks'
                    ...
                    <ActionIcon
                        ...
                        onClick={() => {
                            openBlockHwidModal({
                                ...
                                t,
                                onConfirm: ({ hwid, reason, expiresAt }) => {
                                    blockHwid({
                                        variables: {
                                            hwid,
                                            reason,
