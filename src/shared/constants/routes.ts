export const ROUTES = {
    ...
    DASHBOARD: {
        ...
        MANAGEMENT: {
            ...
            TELEGRAM_NOTIFICATION_ROUTES: '/dashboard/management/telegram-routes',
            DATABASE_BACKUP: '/dashboard/management/database-backup',
            DATABASE_MANAGEMENT: '/dashboard/management/database-management',
            POSTGRES_MANAGEMENT: '/dashboard/management/postgres',
            NODE_PLUGINS: {
        ...
        TOOLS: {
            ...
            USER_ACTIVITY_TIMELINE: '/dashboard/tools/user-activity-timeline',
